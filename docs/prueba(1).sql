...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2025 a las 17:28:15
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fk_usuario_postulante` (`idpostulante`);
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_usuario_postulante` FOREIGN KEY (`idpostulante`) REFERENCES `postulante` (`idpostulante`);
COMMIT;
